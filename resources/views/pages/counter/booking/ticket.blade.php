...
.ticket-top-bar {
    ...
    box-shadow: inset 0 0 0 1000px var(--ticket-red) !important; /* The Magic Fix */
...
.ticket-main-content {
    ...
    box-shadow: inset 0 0 0 1000px var(--ticket-bg) !important; /* The Magic Fix */
    flex-grow: 1;
    display: grid;
...
.ticket-right::before { top: -10px; }
.ticket-right::after { bottom: -10px; }

/* Data Display */
.data-label { font-size: 13px; color: #777; margin-bottom: 2px; display: block; }
.data-value { font-size: 16px; font-weight: 700; color: #222; text-transform: uppercase; }

.ticket-brand { font-size: 22px; font-weight: 800; color: #ffffff !important; }
.ticket-brand span { font-size: 14px; font-weight: 400; display: block; opacity: 0.9; }
...
.stub-content { padding: 25px; }
.stub-header { font-weight: 800; color: var(--ticket-red) !important; margin-bottom: 15px; font-size: 18px; }
...
@media print {
    ...
    .ticket-wrapper { padding: 0 !important; background: none !important; margin-top: 50px; }
    .ticket { box-shadow: none !important; border: 1px solid #eee !important; width: 100% !important; border-radius: 0; }
    .ticket-right::before, .ticket-right::after { display: none; } /* Hide the grey circles on white paper */
                ...
                <div class="ticket-main-content">
                    ...
                    <div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <span class="data-value">{{ \Carbon\Carbon::parse($bookingData->schedule?->set_date)->format('d M Y') }}</span>
                            </div>
                            <div class="col-6">
                    ...
                    <div class="col-12 mt-3 pt-3 border-top d-flex justify-content-between">
                        <div>
                            ...
                            <span class="data-value" style="color: var(--ticket-red) !important;">{{ session('pnr') ?? $bookingData->ticket->pnr }}</span>
                        </div>
                        <div class="text-end">
                            <span class="data-label">Total Fare:</span>
                            <span class="data-value" style="font-size: 20px;">৳ {{ number_format($bookingData->total, 2) }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="ticket-right">
                ...
                <div class="stub-content">
                    ...
                    <div class="mb-2">
                        ...
                        <span class="data-value" style="font-size: 14px;">{{ $bookingData->selected_seats }} / {{ \Carbon\Carbon::parse($bookingData->schedule?->set_date)->format('d M') }}</span>
                    </div>
