...
<div class="container my-5">
  <h4 class="mb-4 text-main fw-bold">📅 Upcoming Trips</h4>
    ...
    <table class="table table-bordered text-center align-middle">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td>{{ $res->schedule->bus->bus_number ?? 'N/A' }}</td>
          <td>{{ $res->selected_seats }}</td>
          <td><span class="badge bg-info text-dark">{{ ucfirst($res->schedule->status) }}</span></td>
        </tr>
        @endforeach
      </tbody>
    </table>
